...
void CashierForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CashierForm *_t = static_cast<CashierForm *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CashierForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CashierForm.data,
      qt_meta_data_CashierForm,  qt_static_metacall, nullptr, nullptr}
};
