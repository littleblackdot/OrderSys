...
QT_MOC_LITERAL(7, 69, 11), // "closeReport"
QT_MOC_LITERAL(8, 81, 7) // "tableid"

    },
    "ServerThread\0tableIdReport\0\0tableId\0"
    "QTcpSocket*\0socket\0requestReport\0"
    "closeReport\0tableid"
};
...
void ServerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->closeReport((*reinterpret_cast< QTcpSocket*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (ServerThread::*_t)(int , QTcpSocket * );
        ...
        {
            typedef void (ServerThread::*_t)(QTcpSocket * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerThread::closeReport)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void ServerThread::closeReport(QTcpSocket * _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
